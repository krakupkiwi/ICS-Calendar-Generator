...
// ─── Timezone ─────────────────────────────────────────────────────────────────
// Set TZ_ID in your .env / docker-compose environment to match your club's timezone.
// Uses IANA timezone names — see https://en.wikipedia.org/wiki/List_of_tz_database_time_zones
const TIMEZONE = process.env.TZ_ID || 'Australia/Perth';
...
function buildSummary(fixture, teamFilter) {
  ...
  return `${teamFilter} vs ${opponent} ${tag}${roundTag}`;
}
